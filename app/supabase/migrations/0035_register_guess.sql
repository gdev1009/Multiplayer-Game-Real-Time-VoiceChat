-- =============================================================================
-- 0035_register_guess.sql
-- =============================================================================
-- Second half, second question (Ronna, Sep 2026): the guess never registered
-- and the same player stayed on the clock.
--
--  * Grade like the phone does (ignore punctuation) so a spoken "Apple!"
--    counts as Apple.
--  * A normal clue clears last_outcome. 0034 does this too; repeated here so
--    running this script alone is enough if 0034 was never applied.
--
